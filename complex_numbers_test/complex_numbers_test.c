...
/*
  Purpose:
    ...
    complex_numbers_test tests the use of complex numbers.
...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "complex_numbers_test\n" );
  printf ( "  C version\n" );
  printf ( "  Test complex number usage.\n" );
/*
...
*/
  printf ( "  ( complex ) I =      (%14.6g,%14.6g)\n", 
    creal ( ( complex ) I ), cimag ( ( complex ) I ) );
  ...
  printf ( "  cpow ( a, 2 ) =      (%14.6g,%14.6g)\n", 
    creal ( cpow ( a, 2 ) ), cimag ( cpow ( a, 2 ) ) );
  printf ( "  cpow ( 2, a ) =      (%14.6g,%14.6g)\n", 
    creal ( cpow ( 2, a ) ), cimag ( cpow ( 2, a ) ) );
  printf ( "  cpow ( a, a ) =      (%14.6g,%14.6g)\n", 
    creal ( cpow ( a, a ) ), cimag ( cpow ( a, a ) ) );
  printf ( "  1/a =                (%14.6g,%14.6g)\n", 
    creal ( 1.0 / a ), cimag ( 1.0 / a ) );
  printf ( "\n" );
  printf ( "  cabs(a) =             %14.6g\n",         cabs ( a ) );
  printf ( "  cacos(a) =           (%14.6g,%14.6g)\n",
    creal ( cacos ( a ) ), cimag ( cacos ( a ) ) );
  printf ( "  cacosh(a) =          (%14.6g,%14.6g)\n",
    creal ( cacosh ( a ) ), cimag ( cacosh ( a ) ) );
  printf ( "  carg(a) =             %14.6g\n",         carg ( a ) );
  printf ( "  casin(a) =           (%14.6g,%14.6g)\n",
    creal ( casin ( a ) ), cimag ( casin ( a ) ) );
  printf ( "  casinh(a) =          (%14.6g,%14.6g)\n",
    creal ( casinh ( a ) ), cimag ( casinh ( a ) ) );
  ...
  printf ( "  (complex)(1) =       (%14.6g,%14.6g)\n", 
    creal ( ( complex ) ( 1 ) ), cimag ( ( complex ) ( 1 ) ) );
  printf ( "  (complex)(4.0) =     (%14.6g,%14.6g)\n", 
    creal ( ( complex ) ( 4.0 ) ), cimag ( ( complex ) ( 4.0 ) ) );
...
*/
  printf ( "  ( double complex ) I =  (%14.6g,%14.6g)\n", 
    creal ( ( double complex ) I ), cimag ( ( double complex ) I ) );
  printf ( "  a =                     (%14.6g,%14.6g)\n", 
    creal ( a ), cimag ( a ) );
  printf ( "  - a =                   (%14.6g,%14.6g)\n", 
    creal ( - a ), cimag ( -a ) );
  printf ( "  a + 3 =                 (%14.6g,%14.6g)\n", 
    creal ( a + 3 ), cimag ( a + 3 ) );
  printf ( "  a + (0,5) =             (%14.6g,%14.6g)\n", 
    creal ( a + ( 0.0 + 5.0 * I ) ), cimag ( a + ( 0.0 + 5.0 * I ) ) );
  printf ( "  4 * a =                 (%14.6g,%14.6g)\n", 
    creal ( 4 * a ), cimag ( 4 * a ) );
  printf ( "  a / 8 =                 (%14.6g,%14.6g)\n", 
    creal ( a / 8 ), cimag ( a / 8 ) );
