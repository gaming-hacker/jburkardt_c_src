...
*/
  ...
  if ( rank < 0 || nseq < rank )
  {
    ...
    fprintf ( stderr, "  But 0 <= rank < %d is required.\n", nseq );
    exit ( 1 );
  }
...
int cycle_check ( int n, int ncycle, int t[], int index[] )
...
void dist_next ( int k, int m, int q[], int *leftmost, int *more )
...
/*
  ...
  Parameters:
    ...
    Input/output, int *LEFTMOST, set this to 0 before the first call.
...
/*
  Purpose:
    ...
    I4VEC_PART1_NEW partitions an integer into NPART parts.
...
/*
  ...
  Parameters:
    ...
    Output, int KSUBSET_COLEX_CHECK.
    1, the data is legal.
    0, the data is not legal.
*/
{
...
int part_sf_check ( int n, int npart, int a[] )
...
int tableau_check ( int n, int tab[] )
