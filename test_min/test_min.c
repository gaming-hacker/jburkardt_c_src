...
/*
  ...
  Output:
    ...
    double f1, the first derivative of the 
    objective function.
*/
{
  double f1;
...
/*
  ...
  Input:
    ...
    double X, the point where the gradient is to 
    be approximated.
...
/*
  ...
  Output:
    ...
    double f2, the second derivative.
*/
{
  double f2;
...
/*
  ...
  Output:
    ...
    char *p12_title, a title for the problem.
*/
{
  strcpy ( title, "The fuzzy parabola" );
...
/*
  ...
  Output:
    ...
    char *p13_title, a title for the problem.
*/
{
  strcpy ( title, "The lazy W" );
...
/*
  ...
  Output:
    ...
    char *p14_title, a title for the problem.
*/
{
  strcpy ( title, "Humps" );
