...
*/
int  c1 ( char dir[64] );
void c2 ( int a[ARRSIZE][ARRSIZE] );
void for1 ( int a[ARRSIZE][ARRSIZE] );
void for2 ( int *int_val, float *real_val, float *complex_val, double *d_val );
void for3 ( );
void for4 ( int a[ARRSIZE][ARRSIZE] );
...
*/
{
  ...
  for2 ( &int_val, &real_val, complex_val, &d_val );
...
/*
  Purpose:
    ...
    C1 returns the current working directory as a string.
