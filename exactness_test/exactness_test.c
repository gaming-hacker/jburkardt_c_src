...
*/
{
  ...
  printf ( "\n" );
  printf ( "CHEBYSHEV1_EXACTNESS_TEST\n" );
  printf ( "  Test Gauss-Chebyshev1 rules for the Chebyshev1 integral.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "CHEBYSHEV2_EXACTNESS_TEST\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "CHEBYSHEV3_EXACTNESS_TEST\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "CLENSHAW_EXACTNESS_TEST\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "GEGENBAUER_EXACTNESS_TEST\n" );
  printf ( "  Gauss-Gegenbauer rules for the Gegenbauer integral.\n" );
  printf ( "  Density function rho(x) = (1-x^2)^(lambda-1/2).\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: 2*N-1\n" );
  printf ( "  Parameter LAMBDA = %g\n", lambda );
  ...
  for ( n = 1; n <= 5; n++ )
  {
    if ( n == 1 )
    {
      ...
      w = r8vec_copy_new ( n, w1 );
    }
    else if ( n == 2 )
    {
      x = r8vec_copy_new ( n, x2 );
      w = r8vec_copy_new ( n, w2 );
    }
    else if ( n == 3 )
    {
      x = r8vec_copy_new ( n, x3 );
      w = r8vec_copy_new ( n, w3 );
    }
    else if ( n == 4 )
    {
      x = r8vec_copy_new ( n, x4 );
      w = r8vec_copy_new ( n, w4 );
    }
    else if ( n == 5 )
    {
      x = r8vec_copy_new ( n, x5 );
      w = r8vec_copy_new ( n, w5 );
    }
...
*/
{
  ...
  printf ( "\n" );
  printf ( "HERMITE_1_EXACTNESS_TEST\n" );
  printf ( "  Gauss-Hermite rules for the Hermite integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -oo < x < +oo.\n" );
  printf ( "  Exactness: 2N-1.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "LAGUERRE_EXACTNESS_TEST\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "LAGUERRE_1_EXACTNESS_TEST\n" );
  printf ( "  Gauss-Laguerre rules for the Laguerre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: 0 <= x < +oo.\n" );
  printf ( "  Exactness: 2N-1.\n" );
...
/*
  Purpose:
    ...
    LEGENDRE_EXACTNESS_SET tests Gauss-Legendre rules for the Legendre integral.
