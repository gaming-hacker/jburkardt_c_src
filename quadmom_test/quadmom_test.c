...
/*
  Purpose:
    ...
    QUADMOM_TEST06 tests QUADMOM for the lower truncated normal weight.
...
/*
  Purpose:
    ...
    QUADMOM_TEST07 tests QUADMOM procedure for the upper truncated normal weight.
