...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_CR_FA_TEST:\n" );
  printf ( "  R83_CR_FA factors an R83 matrix using cyclic reduction;\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_CR_SL_TEST:\n" );
  printf ( "  R83_CR_SL solves a linear system A*x=b with R83 matrix\n" );
  printf ( "  using cyclic reduction, after factorization by R83_CR_FA.\n" );
  printf ( "\n" );
  printf ( "  Matrix order N = %d\n", n );
  printf ( "  The matrix is NOT symmetric.\n" );
/*
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_CR_SLS_TEST\n" );
  printf ( "  R83_CR_SLS solves multiple linear systems A*x=b1:bn with R83 matrix\n" );
  printf ( "  using cyclic reduction, after factorization by R83_CR_FA.\n" );
  printf ( "\n" );
  printf ( "  Matrix order N = %d\n", n );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_DIF2_TEST\n" );
  printf ( "  R83_DIF2 sets up the second difference matrix.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_INDICATOR_TEST\n" );
  printf ( "  R83_INDICATOR sets up an R83 indicator matrix.\n" );
  printf ( "  We check three cases, M<N, M=N, M>N.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_MTV_TEST\n" );
  printf ( "  R83_MTV computes b=A'*x, where A is an R83 matrix.\n" );
  printf ( "  We check three cases, M<N, M=N, M>N.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_MV_TEST\n" );
  printf ( "  R83_MV computes b=A*x, where A is an R83 matrix.\n" );
  printf ( "  We check three cases, M<N, M=N, M>N.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_PRINT_TEST\n" );
  printf ( "  R83_PRINT prints an R83 matrix.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_PRINT_SOME_TEST\n" );
  printf ( "  R83_PRINT_SOME prints some of an R83 matrix.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_RANDOM_TEST\n" );
  printf ( "  R83_RANDOM randomizes an R83 matrix.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_RES_TEST\n" );
  printf ( "  R83_RES computes b-A*x, where A is an R83 matrix.\n" );
  printf ( "  We check three cases, M<N, M=N, M>N.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_TO_R8GE_TEST\n" );
  printf ( "  R83_TO_R8GE converts an R83 matrix to R8GE format.\n" );
  printf ( "  We check three cases, M<N, M=N, M>N.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "R83_ZEROS_TEST\n" );
  printf ( "  R83_ZEROS zeros an R83 matrix.\n" );
