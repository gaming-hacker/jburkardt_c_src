...
/*
  Purpose:
    ...
    LINE01_SAMPLE_ERGODIC samples points on the unit line in 1D.
...
double *line01_sample_random ( int n, int *seed )

/******************************************************************************/
/*
  Purpose:

    LINE01_SAMPLE_RANDOM samples points on the unit line in 1D.
