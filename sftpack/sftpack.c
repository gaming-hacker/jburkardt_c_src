...
*/
{
  ...
  for ( i2 = 0; i2 < n2; i2++ )
  {
    for ( j2 = 0; j2 < n2; j2++ )
    {
      theta2 = 2.0 * r4_pi * ( float ) ( i2 * j2 ) / ( float ) ( n2 );
      cs2.real =   cos ( theta2 );
      cs2.imag = - sin ( theta2 );
      for ( i1 = 0; i1 < n1; i1++ )
      {
        for ( j1 = 0; j1 < n1; j1++ )
        {
          theta1 = 2.0 * r4_pi * ( float ) ( i1 * j1 ) / ( float ) ( n1 );
          cs1.real =   cos ( theta1 );
          cs1.imag = - sin ( theta1 );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    for ( j = 0; j < n; j++ )
    {
      theta = - 2.0 * r4_pi * ( float ) ( i * j ) / ( float ) ( n );
      x[i].real = x[i].real 
        + y[j].real * cos ( theta )
        - y[j].imag * sin ( theta );
      x[i].imag = x[i].imag 
...
*/
{
  ...
  for ( i2 = 0; i2 < n2; i2++ )
  {
    for ( j2 = 0; j2 < n2; j2++ )
    {
      theta2 = 2.0 * r8_pi * ( double ) ( i2 * j2 ) / ( double ) ( n2 );
      cs2.real =   cos ( theta2 );
      cs2.imag = - sin ( theta2 );
      for ( i1 = 0; i1 < n1; i1++ )
      {
        for ( j1 = 0; j1 < n1; j1++ )
        {
          theta1 = 2.0 * r8_pi * ( double ) ( i1 * j1 ) / ( double ) ( n1 );
          cs1.real =   cos ( theta1 );
          cs1.imag = - sin ( theta1 );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    for ( j = 0; j < n; j++ )
    {
      theta = - 2.0 * r8_pi * ( double ) ( i * j ) / ( double ) ( n );
      x[i].real = x[i].real 
        + y[j].real * cos ( theta )
        - y[j].imag * sin ( theta );
      x[i].imag = x[i].imag 
...
*/
{
  ...
  y = ( doublecomplex * ) malloc ( n * sizeof ( doublecomplex ) );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    for ( k = 0; k < ( n / 2 ); k++ )
    {
      theta = ( float ) ( ( k + 1 ) * i * 2 ) * r4_pi / ( float ) ( n );
...
*/
{
  ...
  *azero = *azero / ( float ) ( n );
  ...
  for ( i = 0; i < ( n / 2 ); i++ )
  {
    ...
    for ( j = 0; j < n; j++ )
    {
      theta = ( float ) ( 2 * ( i + 1 ) * j ) * r4_pi / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 2.0 * r4_pi * ( float ) ( ( i * j ) % n ) / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 1; j < n; j++ )
    {
      theta = 0.5 * r4_pi * ( float ) ( j * ( 2 * i + 1 ) ) / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 0.5 * r4_pi * ( float ) ( i * ( 2 * j + 1 ) ) / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n - 1; j++ )
    {
      theta = 0.5 * r4_pi * ( float ) ( ( j + 1 ) * ( 2 * i + 1 ) ) 
        / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 0.5 * r4_pi * ( float ) (  ( i + 1 ) * ( 2 * j + 1 ) ) 
        / ( float ) ( n );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    theta[i] = r4_pi * ( float ) ( i + 1 ) / ( float ) ( n + 1 );
  }
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    for ( k = 0; k < ( n / 2 ); k++ )
    {
      theta = ( double ) ( ( k + 1 ) * i * 2 ) * r8_pi / ( double ) ( n );
      r[i] = r[i] + a[k] * cos ( theta ) + b[k] * sin ( theta );
    }
  }
...
*/
{
  ...
  *azero = *azero / ( double ) ( n );
  ...
  for ( i = 0; i < ( n / 2 ); i++ )
  {
    ...
    for ( j = 0; j < n; j++ )
    {
      theta = ( double ) ( 2 * ( i + 1 ) * j ) * r8_pi / ( double ) ( n );
      a[i] = a[i] + r[j] * cos ( theta );
      b[i] = b[i] + r[j] * sin ( theta );
    }
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 2.0 * r8_pi * ( double ) ( ( i * j ) % n ) / ( double ) ( n );
      b[i] = b[i] + a[j] * ( cos ( theta ) + sin ( theta ) );
    }
  }
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 1; j < n; j++ )
    {
      theta = 0.5 * r8_pi * ( double ) ( j * ( 2 * i + 1 ) ) / ( double ) ( n );
      y[i] = y[i] + 2.0 * x[j] * cos ( theta  );
    }
  }
  return y;
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 0.5 * r8_pi * ( double ) ( i * ( 2 * j + 1 ) ) / ( double ) ( n );
      y[i] = y[i] + x[j] * cos ( theta  );
    }
  }
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n - 1; j++ )
    {
      theta = 0.5 * r8_pi * ( double ) ( ( j + 1 ) * ( 2 * i + 1 ) ) 
        / ( double ) ( n );
      y[i] = y[i] - 2.0 * x[j] * sin ( theta  );
    }
    theta = r8_pi * ( double ) ( i );
    y[i] = y[i] - x[n-1] * cos ( theta );
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      theta = 0.5 * r8_pi * ( double ) (  ( i + 1 ) * ( 2 * j + 1 ) ) 
        / ( double ) ( n );
      y[i] = y[i] + x[j] * sin ( theta );
    }
  }
...
*/
{
  ...
  for ( i = 0; i < n; i++ )
  {
    theta[i] = r8_pi * ( double ) ( i + 1 ) / ( double ) ( n + 1 );
  }
...
double *r8vec_swtb ( int n, double s[], double d[] )
...
*/
{
  ...
  for ( i = 0; i < np1h; i++ )
  {
    d[i] = d[i] / ( ( sqrt ( 3.0 ) + 1.0 ) / sqrt ( 2.0 ) );
    s[i] = s[i] / ( ( sqrt ( 3.0 ) - 1.0 ) / sqrt ( 2.0 ) );
  }
  ...
  for ( i = 0; i < np1h; i++ )
  {
    ...
    y[2*i+1] = d[i] + sqrt ( 3.0 ) / 4.0 * s[i] 
      + ( sqrt ( 3.0 ) - 2.0 ) / 4.0 * s[im1];
  }

  for ( i = 0; i < np1h; i++ )
  {
    y[2*i] = s[i] - sqrt ( 3.0 ) * y[2*i+1];
  } 
...
void r8vec_swtf ( int n, double x[], double s[], double d[] )
...
*/
{
  ...
  for ( i = 0; i < np1h; i++ )
  {
    s[i] = y[2*i] + sqrt ( 3.0 ) * y[2*i+1];
  }

  for ( i = 0; i < np1h; i++ )
  {
    im1 = i4_wrap ( i - 1, 0, np1h - 1 );
    d[i] = y[2*i+1] - sqrt ( 3.0 ) / 4.0 * s[i]
      - ( sqrt ( 3.0 ) - 2.0 ) / 4.0 * s[im1];
  }
  ...
  for ( i = 0; i < np1h; i++ )
  {
    s[i] = ( sqrt ( 3.0 ) - 1.0 ) / sqrt ( 2.0 ) * s[i];
    d[i] = ( sqrt ( 3.0 ) + 1.0 ) / sqrt ( 2.0 ) * d[i];
  }
