...
*/
{
  ...
  phiw = ( double * ) malloc ( ( n + 1 ) * ( n + 1 ) * sizeof ( double ) );
...
void t_polynomial_plot ( int n_num, int n_val[], char *output_filename )
...
/*
  ...
  Parameters:
    ...
    Input, char *OUTPUT_FILENAME, the name into which the 
...
*/
  strcpy ( data_filename, "t_polynomial_data.txt" );
...
*/
  strcpy ( command_filename, "t_polynomial_commands.txt" );
  ...
  fprintf ( command_unit, "set ylabel '<---T(n,x)--->'\n" );
  fprintf ( command_unit, "set title 'Chebyshev Polynomials T(n,x)'\n" );
  ...
  for ( j = 0; j < n_num; j++ )
  {
    ...
    fprintf ( command_unit, "'%s' using 1:%d lw 3 linecolor rgb 'red'", data_filename, column );
    if ( j < n_num - 1 )
    {
      fprintf ( command_unit, ", \\\n" );
    }
...
/*
  ...
  Discussion:
    ...
    Thanks to Csaba Kertesz for pointing out the need to free temporary memory, 
    06 November 2015.
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "TT_PRODUCT_INTEGRAL - Fatal error!\n" );
...
void u_polynomial_plot ( int n_num, int n_val[], char *output_filename )
...
/*
  Create the data file.
*/
  strcpy ( data_filename, "u_polynomial_data.txt" );
  data_unit = fopen ( data_filename, "wt" );
  for ( i = 0; i < m; i++ )
  {
    fprintf ( data_unit, "%g", x[i] );
...
/*
  Plot the selected data.
*/
  strcpy ( command_filename, "u_polynomial_commands.txt" );
  command_unit = fopen ( command_filename, "wt" );
  ...
  fprintf ( command_unit, "set output '%s'\n", output_filename );
  fprintf ( command_unit, "set xlabel '<---X--->'\n" );
  fprintf ( command_unit, "set ylabel '<---U(n,x)--->'\n" );
  fprintf ( command_unit, "set title 'Chebyshev Polynomials U(n,x)'\n" );
  fprintf ( command_unit, "set grid\n" );
  fprintf ( command_unit, "set style data lines\n" );
  for ( j = 0; j < n_num; j++ )
  {
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "UU_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
...
/*
  ...
  Parameters:
    ...
    Output, double V_POLYNOMIAL[M*(N+1)], the values of the N+1 
    Chebyshev polynomials.
*/
{
  int i;
...
void v_polynomial_plot ( int n_num, int n_val[], char *output_filename )
...
/*
  Create the data file.
*/
  strcpy ( data_filename, "v_polynomial_data.txt" );
  data_unit = fopen ( data_filename, "wt" );
  for ( i = 0; i < m; i++ )
  {
    fprintf ( data_unit, "%g", x[i] );
...
/*
  Plot the selected data.
*/
  strcpy ( command_filename, "v_polynomial_commands.txt" );
  command_unit = fopen ( command_filename, "wt" );
  ...
  fprintf ( command_unit, "set output '%s'\n", output_filename );
  fprintf ( command_unit, "set xlabel '<---X--->'\n" );
  fprintf ( command_unit, "set ylabel '<---V(n,x)--->'\n" );
  fprintf ( command_unit, "set title 'Chebyshev Polynomials V(n,x)'\n" );
  fprintf ( command_unit, "set grid\n" );
  fprintf ( command_unit, "set style data lines\n" );
  for ( j = 0; j < n_num; j++ )
  {
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "VV_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
...
/*
  ...
  Parameters:
    ...
    Output, double W_MOMENT, the value of the integral.
*/
{
  double f1;
  double f2;
...
void w_polynomial_plot ( int n_num, int n_val[], char *output_filename )
...
/*
  Create the data file.
*/
  strcpy ( data_filename, "w_polynomial_data.txt" );
  data_unit = fopen ( data_filename, "wt" );
  for ( i = 0; i < m; i++ )
  {
    fprintf ( data_unit, "%g", x[i] );
...
/*
  Plot the selected data.
*/
  strcpy ( command_filename, "w_polynomial_commands.txt" );
  command_unit = fopen ( command_filename, "wt" );
  ...
  fprintf ( command_unit, "set output '%s'\n", output_filename );
  fprintf ( command_unit, "set xlabel '<---X--->'\n" );
  fprintf ( command_unit, "set ylabel '<---W(n,x)--->'\n" );
  fprintf ( command_unit, "set title 'Chebyshev Polynomials W(n,x)'\n" );
  fprintf ( command_unit, "set grid\n" );
  fprintf ( command_unit, "set style data lines\n" );
  for ( j = 0; j < n_num; j++ )
  {
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "WW_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
