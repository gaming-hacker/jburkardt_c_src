...
/*
  ...
  Local parameters:
    ...
    Local, int NX, the number of nodes in the X direction.
 
    Local, int NY, the number of nodes in the Y direction.

    Local, double XL, the X coordinate of the left side of the rectangle.

    Local, double XR, the X coordinate of the right side of the rectangle.

    Local, double YB, the Y coordinate of the bottom of the rectangle.

    Local, double YT, the Y coordinate of the top of the rectangle.
*/
{
  int nx = 17;
  int ny = 17;
...
*/
      for ( ti1 = 0; ti1 < 3; ti1++ )
      {
        ...
        rhs = 2.0 * r8_pi * r8_pi * sin ( r8_pi * xq ) * sin ( r8_pi * yq );
  ...
  for ( j = 1; j <= ny; j++ )
  {
    for ( i = 1; i <= nx; i++ )
    {
      ...
      printf ( "  %4d  %4d  %4d  %10g  %10g  %14g  %14g  %14g\n",
        k, i, j, x[k], y[k], u, c[k], fabs ( u - c[k] ) );
...
*/
{
  ...
  *dudx = r8_pi * cos ( r8_pi * x ) * sin ( r8_pi * y ) + 1.0;
