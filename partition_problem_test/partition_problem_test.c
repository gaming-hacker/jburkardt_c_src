...
int main ( );
void partition_brute_test ( int n, int w[] );
void partition_count_test ( int n, int w[] );
...
/*
  ...
  Discussion:
    ...
    PARTITION_PROBLEM_TEST tests the PARTIION_PROBLEM library.
...
*/
{
  ...
  printf ( "\n" );
  printf ( "PARTITION_BRUTE_TEST:\n" );
  printf ( "  PARTITION_BRUTE_TEST partitions a set of N integers W so that the subsets\n" );
