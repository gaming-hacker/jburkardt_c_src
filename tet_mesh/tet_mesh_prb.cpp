...
# define N 10
  ...
  for ( j = 0; j < N; j++ )
  {
   printf ( "  " << setprecision(4) << setw(8) << ref[0+j*3]
...
//
{
  ...
  printf ( "\n" );
  printf ( "  Quadratic mesh size is       " << tet_num1 << "\n" );
  printf ( "  Linearized mesh size will be " << tet_num2 << "\n" );
...
//
{
  ...
  printf ( "\n" );
  printf ( "  This mesh has tetrahedron order " << tet_order << "\n" );
  printf ( "  The number of tetrahedrons is   " << tet_num << "\n" );
  ...
  printf ( "\n" );
  printf ( "  Number of tetrahedrons * order = " << tet_num * tet_order << "\n" );
  printf ( "  Sum of node orders             = " << i4vec_sum ( node_num, node_order ) << "\n" );
...
//
    for ( test2 = 1; test2 <= test2_num; test2++ )
    {
      ...
      for ( i = 0; i < 4; i++ )
      {
        printf ( "  " << setprecision(6) << setw(14) << c1[i];
      }
      printf ( "\n" );
      printf ( "  C2 = ";
      for ( i = 0; i < 4; i++ )
      {
        printf ( "  " << setprecision(6) << setw(14) << c2[i];
      }
      printf ( "\n" );
...
//
    ...
    printf ( "\n" );
    printf ( "  Point was chosen from tetrahedron    " << setw(8) << tet1 << "\n" );
...
//
    ...
    printf ( "  Naive search ended in tetrahedron    " << setw(8) << tet2
...
//
    ...
    printf ( "  Delaunay search ended in tetrahedron " << setw(8) << tet3
         << ", number of steps = " << step_num << "\n" );
  }
