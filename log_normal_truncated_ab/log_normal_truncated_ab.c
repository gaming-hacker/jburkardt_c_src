...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_CDF - Fatal error!\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_CDF_INV - Fatal error!\n" );
    fprintf ( stderr, "  Parameters are not legal.\n" );
    exit ( 1 );
  }
...
int log_normal_truncated_ab_check ( double mu, double sigma, double a, 
  double b )
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_MEAN - Fatal error!\n" );
    fprintf ( stderr, "  Parameters are not legal.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_SAMPLE - Fatal error!\n" );
    fprintf ( stderr, "  Parameters are not legal.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "LOG_NORMAL_TRUNCATED_AB_VARIANCE - Fatal error!\n" );
    fprintf ( stderr, "  Parameters are not legal.\n" );
    exit ( 1 );
  }
