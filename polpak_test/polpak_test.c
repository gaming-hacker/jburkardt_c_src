...
void tribonacci_direct_test ( );
void tribonacci_recursive_test ( );
void tribonacci_roots_test ( );
void trinomial_test ( );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "BELL_POLY_COEF_TEST\n" );
  printf ( "  BELL_POLY_COEF returns the coefficients of a\n" );
  printf ( "  Bell polynomial.\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "DELANNOY_TEST\n" );
  printf ( "  DELANNOY computes the Delannoy numbers A(0:M,0:N).\n" );
  printf ( "  A(M,N) counts the paths from (0,0) to (M,N).\n" );
  printf ( "\n" );

  a = delannoy ( m, n );

  i4mat_print ( m + 1, n + 1, a, "  The Delannoy numbers:" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "DOMINO_TILING_NUM_TEST:\n" );
  printf ( "  DOMINO_TILING_NUM returns the number of tilings of an\n" );
  printf ( "  MxN rectangle by dominoes.\n" );
  printf ( "\n" );
  printf ( "   M   N    Tilings\n" );
...
*/
{
  int i;
  int i4;
  int i4_test[10] = { - 13, 0, 1, 8, 10, 50, 55, 100, 144, 200 };
  int l;
  int test_num = 10;

  printf ( "\n" );
  printf ( "I4_IS_FIBONACCI_TEST\n" );
  printf ( "  I4_IS_FIBONACCI determines if an I4 is a Fibonacci number.\n" );
  printf ( "\n" );
  printf ( "   I4       T/F\n" );
  printf ( "\n" );
...
# define SLICE_MAX 8
  ...
  printf ( "\n" );
  printf ( "SLICES_TEST:\n" );
  printf ( "  SLICES determines the maximum number of pieces created\n" );
  ...
  for ( dim_num = 1; dim_num <= dim_max; dim_num++ )
  {
    ...
    {
      piece_num = slices ( dim_num, slice_num );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "tribonacci_direct_test():\n" );
  printf ( "  tribonacci_direct() computes the Tribonacci sequence.\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "tribonacci_recursive_test():\n" );
  printf ( "  tribonacci_recursive() computes the Tribonacci sequence.\n" );
  printf ( "\n" );

  n = 23; 
  f = malloc ( n * sizeof ( int ) );

  tribonacci_recursive ( n, f );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "tribonacci_roots_test():\n" );
  printf ( "  tribonacci_roots() computes the Tribonacci roots.\n" );
  printf ( "\n" );

  tribonacci_roots ( &alpha, &beta, &gamma );

  p = pow ( alpha, 3 ) - pow ( alpha, 2 ) - alpha - 1.0;
  printf ( "  alpha = %g, p(alpha) = %g\n", alpha, p );

  pc = cpow ( beta, 3 ) - cpow ( beta, 2 ) - beta - 1.0;
  printf ( "  beta = %g+%gi, p(beta) = %g+%gi\n",
    creal ( beta ), cimag ( beta ), creal ( pc ), cimag ( pc ) );

  pc = cpow ( gamma, 3 ) - cpow ( gamma, 2 ) - gamma - 1.0;
  printf ( "  gamma = %g+%gi, p(gamma) = %g+%gi\n",
    creal ( gamma ), cimag ( gamma ), creal ( pc ), cimag ( pc ) );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "ZETA_M1_TEST\n" );
  printf ( "  ZETA_M1 computes the Zeta Minus One function.\n" );
  printf ( "  Requested relative tolerance = %g\n", tol );
  printf ( "\n" );
  printf ( "       P            ZETA_M1(P)         ZETA_M1(P)\n" );
  printf ( "                    tabulated          computed\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "ZETA_NAIVE_TEST\n" );
  printf ( "  ZETA_NAIVE computes the Zeta function.\n" );
  printf ( "\n" );
