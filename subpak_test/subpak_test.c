...
void angle_shift_test ( );
void angle_shift_deg_test ( );
void test03 ( );
void test04 ( );
void test05 ( );
void test06 ( );
...
*/
{
  ...
  printf ( "SUBPAK_TEST\n" );
  printf ( "  C version\n" );
  printf ( "  Test the SUBPAK library.\n" );
...
*/
{
  ...
  for ( i = 1; i <= 10; i++ )
  {
    ...
    printf ( "  %12d  %12d  %12f  %12f  %12f\n", ( int ) seed_in, ( int ) seed_out, r1, r2, r3 );
  }
