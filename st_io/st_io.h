...
void r8st_print ( int m, int n, int nst, int ist[], int jst[], 
  double ast[], char *title );
void r8st_print_some ( int row1, int row2, int col1, int col2, int nst,
  int ist[], int jst[], double ast[], char *title );
void r8st_sort_a ( int m, int n, int nst, int ist[], int jst[], 
  double ast[] );
void r8st_transpose ( int *m, int *n, int nst, int ist[], int jst[], 
  double ast[] );
void r8st_write ( char *output_filename, int m, int n, int nst, 
