...
/*
  ...
  Parameters:
    ...
    Input, char *INPUT_FILENAME, the name of the 
file.
...
*/
{
  ...
  for ( k = 0; k < nst; k++ )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "R8ST_DATA_READ - Fatal error!\n" );
...
void r8st_header_read ( char *input_filename, int *i_min, int *i_max, 
  int *j_min, int *j_max, int *m, int *n, int *nst )
...
void r8st_print ( int m, int n, int nst, int ist[], int jst[], double ast[], 
  char *title )
...
void r8st_print_some ( int i_min, int i_max, int j_min, int j_max, int nst, 
...
/*
  ...
  Parameters:
    ...
    Input, int J_MIN, J_MAX, the first and last columns to print.
...
void r8st_sort_a ( int m, int n, int nst, int ist[], int jst[], double ast[] )
...
void r8st_transpose ( int *m, int *n, int nst, int ist[], int jst[], 
  double ast[] )
...
void r8st_write ( char *output_filename, int m, int n, int nst, int ist[], 
  int jst[], double ast[] )
