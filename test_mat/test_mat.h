...
double c8mat_is_eigen_right ( int n, int k, double complex a[], 
  double complex x[], double complex lambda[] );
...
double complex *hess4 ( );
double complex hess4_determinant ( );
double complex *hess4_eigen_right ( );
double complex *hess4_eigenvalues ( );
double complex *hess4_inverse ( );
double *hess5 ( );
double hess5_determinant ( );
double complex *hess5_eigen_right ( );
double complex *hess5_eigenvalues ( );
...
double complex *r8mat_to_c8mat ( int m, int n, double r8mat[] );
...
double complex *tribonacci2_eigen_right ( int n );
double complex *tribonacci2_eigenvalues ( int n );
