...
void  bars3d (float *xray, float *yray, float *z1ray, float *z2ray,
             float *xwray, float *ywray, int *icray, int n);
...
void  mysymb (float *xray, float *yray, int n, int isym, int iflag);
...
void  trfmat (float *zmat, int nx, int ny, float *zmat2, int nx2, int ny2);
...
int   triang (float *xray, float *yray, int n, int *i1ray, int *i2ray,
              int *i3ray, int nmax); 
void  trifll (float *xray, float *yray);
void  triplx (void);
void  tripts (float *xray, float *yray, float *zray, int n, int *i1ray, 
              int *i2ray, int *i3ray, int ntri, float zlev, float *xpts,
              float *ypts, int maxpts, int *nptray, int maxray, int *nlins);
