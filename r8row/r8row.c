...
void r8row_print ( int m, int n, double a[], char *title )
...
*/
{
  ...
  s = ( double * ) malloc ( m * ( n + 1 ) * sizeof ( double ) );
/*
  Sum.
*/
  for ( i = 0; i < m; i++ )
...
void r8row_transpose_print ( int m, int n, double a[], char *title )
...
/*
  Purpose:
    ...
    R8ROW_UNIFORM_AB_NEW returns a scaled pseudorandom R8ROW.
