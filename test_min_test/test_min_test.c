...
*/
{
  ...
  printf ( "\n" );
  printf ( "p00_title_test\n" );
  printf ( "  p00_title prints the title of any problem.\n" );
/*
...
*/
  ...
  for ( problem = 1; problem <= problem_num; problem++ )
  {
    ...
    printf ( "\n" );
    printf ( "   A,       B:  %16.10g                      %16.10g\n", a, b );
    printf ( "  FA,      FB:  %16.10g                      %16.10g\n", fa, fb );
    ...
    printf ( "\n" );
    printf ( "   A,  X*,  B:  %16.10g  %16.10g  %16.10g\n", a, x, b );
    printf ( "  FA, FX*, FB:  %16.10g  %16.10g  %16.10g\n", fa, fx, fb );
  }
