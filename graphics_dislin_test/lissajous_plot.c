...
/*
  Purpose:
    ...
    LISSAJOUS_PLOT uses DISLIN to draw a plot of a Lissajous planar curve.
...
/*
  Read the data.
*/
  r4mat_header_read ( "lissajous_data.txt", &m, &n );

  xy = r4mat_data_read ( "lissajous_data.txt", m, n );
/*
