...
/*
  Purpose:
    ...
    album_bar uses DISLIN to draw a bar chart.
...
*/
{
  ...
  printf ( "album_bar:\n" );
  printf ( "  C version\n" );
  printf ( "  Use DISLIN routines to make a bar chart of music album sales.\n" );
/*
  Read the data.
*/
  r4mat_header_read ( "album_data.txt", &m, &n );

  xy = r4mat_data_read ( "album_data.txt", m, n );
/*
...
*/
  ...
  graf ( xmin, xmax, xorg, xstp, ymin, ymax, yorg, ystp );
/*
  BEGIN LEVEL 2 COMMANDS.

  Define the title.
*/
  titlin ( "Music album sales, all formats", 1 );
  title ( );
/*
