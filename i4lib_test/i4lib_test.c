...
void i4_to_triangle_lower_test ( );
...
void i4vec_identity_row_new_test ( );
...
void i4vec_is_ascending_test ( );
void i4vec_is_binary_test ( );
void i4vec_is_descending_test ( );
void i4vec_is_pairwise_prime_test ( );
void i4vec_max_test ( );
...
void i4vec_width_test ( );

void i4vec2_print_test ( );
...
void permutation_symbol_test ( );

void prime_test ( );

void triangle_lower_to_i4_test ( );
void triangle_upper_to_i4_test ( );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_AND_TEST\n" );
  printf ( "  I4_OR returns the bitwise AND of\n" );
  printf ( "  two I4's.\n" );
  printf ( "\n" );
  printf ( "       I       J  I4_AND    I&J\n" );
  printf ( "\n" );
...
*/
{
  ...
  int i;
  int k;
  int k_test[4] = { 3, 999, 3, 10 };
  int n;
  int n_test[4] = { 10, 1000, 100, 100 };

  printf ( "\n" );
  printf ( "I4_CHOOSE_CHECK_TEST\n" );
  printf ( "  I4_CHOOSE_CHECK checks whether C(N,K)\n" );
  printf ( "  can be computed with integer arithmetic\n" );
  printf ( "  or not.\n" );
  printf ( "\n" );
  printf ( "     N     K    CHECK?    I4_CHOOSE\n" );
  printf ( "\n" );
...
*/
{
  ...
  while ( 1 )
  {
    i4_factorial_values ( &n_data, &n, &f1 );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_FACTORIAL_LOG_TEST\n" );
  printf ( "  I4_FACTORIAL_LOG evaluates the log of the factorial function.\n" );
  printf ( "\n" );
  printf ( "         N           lfact        explfact       exact\n" );
  printf ( "\n" );
  ...
  while ( 1 )
  {
    i4_factorial_values ( &n_data, &n, &fact );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_IS_POWER_OF_2_TEST\n" );
  printf ( "  I4_IS_POWER_OF_2 reports whether an I4 is a power of 2.\n" );
  printf ( "\n" );
  printf ( "  I     I4_IS_POWER_OF_2(I)\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_LCM_12N_TEST\n" );
  printf ( "  I4_LCM_12N computes the least common multiple\n" );
  printf ( "  of integer 1 through N\n" );
  printf ( "\n" );
  printf ( "     N   I4_LCM_12N\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_NOT_TEST\n" );
  printf ( "  I4_NOT returns the NOT of an I4 with respect to a maximum J.\n" );
  printf ( "\n" );
  printf ( "       I       J  I4_NOT    ~I + J + 1\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_OR_TEST\n" );
  printf ( "  I4_OR returns the bitwise inclusive OR of\n" );
  printf ( "  two I4's.\n" );
  printf ( "\n" );
  printf ( "       I       J  I4_OR     I|J\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_TO_TRIANGLE_LOWER_TEST\n" );
  printf ( "  I4_TO_TRIANGLE_LOWER converts a linear index to a\n" );
  printf ( "  lower triangular one.\n" );
  printf ( "\n" );
  printf ( "     K  =>   I     J\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4_WIDTH_TEST\n" );
  printf ( "  I4_WIDTH determines the printing width of an I4.\n" );
  printf ( "\n" );
  printf ( "            I4      I4_WIDTH\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4MAT_PRODUCT_ELEMENTWISE_TEST\n" );
  printf ( "  I4MAT_PRODUCT_ELEMENTWISE computes the elementwise\n" );
  printf ( "  product of two I4MATs.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4MAT_RANK_TEST\n" );
  printf ( "  I4MAT_RANK computes the rank of an integer matrix.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4MAT_TRANSPOSE_TEST\n" );
  printf ( "  I4MAT_TRANSPOSE transposes an I4MAT\n" );
  ...
  i4mat_transpose ( m, n, a );

  i4mat_print ( n, m, a, "  Transposed matrix:" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4MAT_WIDTH_TEST\n" );
  printf ( "  I4MAT_WIDTH determines the printing width of an I4MAT.\n" );

  i4mat_print ( m1, n1, a1, "  A1:" );

  printf ( "\n" );
  printf ( "  Printing width of A1 is %d\n", i4mat_width ( m1, n1, a1 ) );

  i4mat_print ( m2, n2, a2, "  A2:" );

  printf ( "\n" );
  printf ( "  Printing width of A2 is %d\n", i4mat_width ( m2, n2, a2 ) );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4ROWS_TO_I4MAT_TEST\n" );
  printf ( "  I4ROWS_TO_I4MAT allows an I4MAT to be initialized\n" );
...
/*
  Purpose:
    ...
    I4VEC_APPEND_TEST tests I4VEC_APPEND;
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_APPEND_TEST\n" );
  printf ( "  I4VEC_APPEND appends a value to the end of an I4VEC;\n" );
  ...
  i4vec_print ( n, a, "  Initial array A:" );

  value = 17;
  i4vec_append ( &n, &a, value );
  i4vec_print ( n, a, "  Array A after append:" );
...
/*
  Purpose:
    ...
    I4VEC_APPEND_NEW_TEST tests I4VEC_APPEND_NEW;
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_APPEND_NEW_TEST\n" );
  printf ( "  I4VEC_APPEND_NEW appends a value to the end of an I4VEC;\n" );
  ...
  {
    value = i;
    b = i4vec_append_new ( n, a, value );
    n = n + 1;
    free ( a );
    a = i4vec_copy_new ( n, b );
    free ( b );
    sprintf ( label, "  Vector after step %d", i );
    i4vec_print ( n, a, label );
  }
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_CHOOSE_TEST:\n" );
  printf ( "  I4VEC_CHOOSE computes the generalized binomial coefficient.\n" );

  m = 5;
  seed = 12345678;

  j = i4vec_uniform_ab_new ( m, 0, 6, &seed );
  k = i4vec_uniform_ab_new ( m, 0, 6, &seed );
...
/*
  Purpose:
    ...
    I4VEC_IDENTITY_ROW_NEW_TEST tests I4VEC_IDENTITY_ROW_NEW.
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_IDENTITY_ROW_NEW_TEST\n" );
  printf ( "  I4VEC_IDENTITY_ROW_NEW returns a row of the identity.\n" );
  printf ( "\n" );

  for ( i = -1; i <= 5; i++ )
  {
    a = i4vec_identity_row_new ( n, i );
    printf ( "  %2d:", i );
    for ( j = 0; j < n; j++ )
    {
      printf ( " %2d", a[j] );
...
*/
  ...
  printf ( "\n" );
  printf ( "I4VEC_IS_ASCENDING_TEST\n" );
  printf ( "  I4VEC_IS_ASCENDING determines if an I4VEC ascends.\n" );
  printf ( "\n" );
...
*/
  ...
  printf ( "\n" );
  printf ( "I4VEC_IS_DESCENDING_TEST\n" );
  printf ( "  I4VEC_IS_DESCENDING determines if an I4VEC descends.\n" );
...
*/
  ...
  printf ( "\n" );
  printf ( "i4VEC_IS_PAIRWISE_PRIME_TEST\n" );
  printf ( "  I4VEC_IS_PAIRWISE_PRIME determines if an I4VEC\n" );
...
# define N 20
  ...
  printf ( "  I4VEC_SEARCH_BINARY_A searches an ascending-sorted array\n" );
  printf ( "  for a value;\n" );
...
# define N 20
  ...
  printf ( "  I4VEC_SEARCH_BINARY_D searches a descending-sorted array\n" );
  printf ( "  for a value;\n" );
  ...
  index = i4vec_search_binary_d ( N, a, search_val );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_SORTED_UNIQUE_COUNT_TEST\n" );
  printf ( "  I4VEC_SORTED_UNIQUE_COUNT counts unique entries in an I4VEC.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_SUM_VEC_TEST\n" );
  printf ( "  I4VEC_SUM_VEC does a pairwise sum of two I4VEC's.\n" );

  n = 5;
  seed = 123456789;

  a = i4vec_uniform_ab_new ( n, 0, 10, &seed );
  i4vec_transpose_print ( n, a, "  A:" );

  b = i4vec_uniform_ab_new ( n, 0, 10, &seed );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC_WIDTH_TEST\n" );
  printf ( "  I4VEC_WIDTH determines the printing width of an I4VEC.\n" );

  i4vec_print ( n, x, "  The I4VEC:" );

  printf ( "\n" );
  printf ( "  Printing width is %d\n", i4vec_width ( n, x ) );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "I4VEC2_PRINT_TEST\n" );
  printf ( "  I4VEC2_PRINT prints a pair of I4VECs\n" );
...
*/
{
  ...
  printf ( "  PERM1_CHECK returns IERROR = %d\n", ierror );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "PERMUTATION_SYMBOL_TEST\n" );
  printf ( "  PERMUTATION_SYMBOL evaluates the Levi-Civita permutation symbol.\n" );

  i4vec_transpose_print ( n, a1, "  Input vector:" );
  value = permutation_symbol ( n, a1 );
  printf ( "  Levi-Civita permutation symbol = %d\n", value );

  i4vec_transpose_print ( n, a2, "  Input vector:" );
  value = permutation_symbol ( n, a2 );
  printf ( "  Levi-Civita permutation symbol = %d\n", value );

  i4vec_transpose_print ( n, a3, "  Input vector:" );
  value = permutation_symbol ( n, a3 );
  printf ( "  Levi-Civita permutation symbol = %d\n", value );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TRIANGLE_LOWER_TO_I4_TEST\n" );
  printf ( "  TRIANGLE_LOWER_TO_I4 converts a lower triangular index to a\n" );
  printf ( "  linear one.\n" );
  printf ( "\n" );
  printf ( "     I     J   ==> K\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TRIANGLE_UPPER_TO_I4_TEST\n" );
  printf ( "  TRIANGLE_UPPER_TO_I4 converts an upper triangular index to a\n" );
  printf ( "  linear one.\n" );
  printf ( "\n" );
  printf ( "     I     J   ==> K\n" );
  printf ( "\n" );
