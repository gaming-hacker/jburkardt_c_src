...
int diagonal ( int im1, int ip1, int n, int prev_node[], int next_node[], 
  double x[], double y[] )
...
int diagonalie ( int im1, int ip1, int n, int next_node[], double x[], 
  double y[] )
...
int in_cone ( int im1, int ip1, int n, int prev_node[], int next_node[], 
  double x[], double y[] )
