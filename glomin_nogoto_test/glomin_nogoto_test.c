...
# include "glomin_nogoto.h"

int main ( );
void test_glomin_nogoto_all ( );
void glomin_nogoto_example ( double a, double b, double c, double m,  double e, 
...
/*
  Purpose:
    ...
    glomin_nogoto_test() tests glomin_nogoto().
...
*/
{
  ...
  timestamp ( );
  printf ( "\n" );
  printf ( "glomin_nogoto_test():\n" );
  printf ( "  GCC version %d.%d.%d\n", 
    __GNUC__, __GNUC_MINOR__,__GNUC_PATCHLEVEL__ );
  printf ( "  glomin_nogoto() seeks a global minimizer of a function F(X)\n" );
  ...
  c = ( a + b ) / 2.0;
  m = 0.0;
  glomin_nogoto_example ( a, b, c, m, e, t, h_01, 
    "h_01(x) = 2 - x" );
  ...
  c = ( a + b ) / 2.0;
  m = 2.0;
  glomin_nogoto_example ( a, b, c, m, e, t, h_02, 
    "h_02(x) = x * x" );
  ...
  c = ( a + b ) / 2.0;
  m = 14.0;
  glomin_nogoto_example ( a, b, c, m, e, t, h_03, 
    "h_03(x) = x^3 + x^2" );
  ...
  c = ( a + b ) / 2.0;
  m = 72.0;
  glomin_nogoto_example ( a, b, c, m, e, t, h_04, 
  ...
  c = ( a + b ) / 2.0;
  m = 72.0;
  glomin_nogoto_example ( a, b, c, m, e, t, h_05, 
...
/*
  Purpose:
    ...
    glomin_nogoto_example() tests glomin_nogoto() on one test function.
...
*/
{
  ...
  fx = glomin_nogoto ( a, b, c, m, e, t, f, &x, &calls );
  fa = f ( a );
  fb = f ( b );
