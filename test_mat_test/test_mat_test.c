...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "test_mat_test():\n" );
  printf ( "  C version\n" );
  printf ( "  Test test_mat().\n" );
/*
  Utilities.
*/
...
*/
  strcpy ( title, "orthogonal_symmetric" );
  n = 5;
...
*/
  strcpy ( title, "ANTIsymmetric_random" );
  n = 5;
  key = 123456789;
  a = antisymmetric_random ( n, key );
  determ2 = r8mat_determinant ( n, a );
  norm_frobenius = r8mat_norm_fro ( n, n, a );
...
/*
  idempotent_random
*/
  strcpy ( title, "idempotent_random" );
  n = 5;
  i4_lo = 0;
  i4_hi = n;
  seed = 123456789;
...
/*
  involutory_RANDOM
*/
  strcpy ( title, "involutory_RANDOM" );
  n = 5;
  i4_lo = 0;
  i4_hi = n;
  seed = 123456789;
  rank = i4_uniform_ab ( i4_lo, i4_hi, &seed );
  key = 123456789;
  a = involutory_random ( n, rank, key );
  determ2 = r8mat_determinant ( n, a );
  norm_frobenius = r8mat_norm_fro ( n, n, a );
  printf ( "  %-20s  %4d  %14g  %14g  %14f\n", 
    title, n, determ1, determ2, norm_frobenius );
...
/*
  orthogonal_random
*/
  strcpy ( title, "orthogonal_random" );
  n = 5;
  key = 123456789;
...
*/
  ...
  key = 123456789;
  a = symmetric_random ( n, d, key );
  lambda = symmetric_random_eigenvalues ( n, d, key );
...
*/
  ...
  k = 5;
  a = fibonacci2_matrix ( n );
  lambda = fibonacci2_eigenvalues ( n );
...
*/
  ...
  key = 123456789;
  a = idempotent_random ( n, rank, key );
  lambda = idempotent_random_eigenvalues ( n, rank, key );
...
*/
  ...
  key = 123456789;
  a = spd_random ( n, key );
  lambda = spd_random_eigenvalues ( n, key );
...
/*
  tribonacci2
*/
  strcpy ( title, "tribonacci2" );
  n = 5;
  k = 5;
  a = tribonacci2_matrix ( n );
  a_complex = r8mat_to_c8mat ( n, n, a );
  lambda_complex = tribonacci2_eigenvalues ( n );
  x_complex = tribonacci2_eigen_right ( n );
  error_frobenius = c8mat_is_eigen_right ( n, k, a_complex, x_complex,
    lambda_complex );
  norm_frobenius = c8mat_norm_fro ( n, n, a_complex );
  printf ( "  %-20s %4d  %4d  %14g  %14g\n",
    title, n, k, norm_frobenius, error_frobenius );
  free ( a );
  free ( a_complex );
...
*/
  ...
  key = 123456789;
  a = symmetric_random ( n, d, key );
  b = symmetric_random_inverse ( n, d, key );
  c = r8mat_inverse ( n, a );
  error_ab = r8mat_is_inverse ( n, a, b );
  error_ac = r8mat_is_inverse ( n, a, c );
  norma_frobenius = r8mat_norm_fro ( n, n, a );
