...
/*
  ...
  Discussion:
    ...
    Thanks to Sreepathi Pai for pointing out that fgetc() returns an unsigned
    char cast to an int, and so the variable C receiving this value should be
    declared as an int, not a char.
