...
//
  ...
  printf ( "Program was invoked with argument string: '%s'\n", message );
//
...
//
  ...
  printf ( "Got past call to XtSetArg\n" );
//
...
//
  ...
  printf ( "Got past call to XtCreateManagedWidget\n" );
//
//  Realize the widgets.
//
...
//
  ...
  printf ( "Got past call to XtRealizeWidget\n" );
//
//  Enter the event loop.
//
  XtMainLoop ( );
  printf ( "Got past call to XtMainLoop.\n" );
...
//
  if ( n <= 1 ) 
  {
    printf ( "CONCAT_ARGS - Returning empty string.\n" );
    return ( "" );
  }
//
...
//
  ...
  {
    printf ( "\n" );
    printf ( "CONCAT_ARGS - Fatal error!\n" );
