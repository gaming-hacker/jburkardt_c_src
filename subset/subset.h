...
void l4vec_next ( int n, int bvec[] );
...
void perm0_canon_to_cycle ( int n, int p1[], int p2[] );
int perm0_check ( int n, int p[] );
void perm0_cycle ( int n, int p[], int *isgn, int *ncycle, int iopt );
void perm0_cycle_to_canon ( int n, int p1[], int p2[] );
...
void subcompnz_next ( int n, int k, int a[], int *more, int *h, int *t, 
  int *n2, int *more2 );
void subcompnz2_next ( int n_lo, int n_hi, int k, int a[], int *more, int *h, 
  int *t, int *n2, int *more2 );
