...
double circle_imp_line_exp_dist_2d ( double r, double pc[2], double p1[2], 
  double p2[2] );
...
bool polygon_contains_point_2d_convex ( int n, double v[], double p[2] );
bool polygon_contains_point_2d_3 ( int n, double v[], double p[2] );
