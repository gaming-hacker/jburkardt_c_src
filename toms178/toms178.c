...
double best_nearby ( double delta[], double point[], double prevbest, 
  int nvars, double f ( double x[], int nvars ) )

/******************************************************************************/
/*
  Purpose:

    best_nearby looks for a better point nearby, one coordinate at a time.
...
int hooke ( int nvars, double startpt[], double endpt[], double rho, 
  double epsilon, int itermax, double f ( double x[], int nvars ) )
